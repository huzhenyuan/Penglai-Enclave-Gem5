...
compwhite        = 
configdir        = config
configpath       = /home/clive/workspace/luxu/spec-cpu2006_backup/config/riscv2.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log              = CPU2006
log_line_width   = 0
logname          = /home/clive/workspace/luxu/spec-cpu2006_backup/result/CPU2006.046.log
lognum           = 046
mach             = default
mail_reports     = all
mailcompress     = 0
...
output_root      = 
outputdir        = output
path             = /home/clive/workspace/luxu/spec-cpu2006_backup/benchspec/CPU2006/429.mcf
plain_train      = 1
prefix           = 
prepared_by      = 
rate             = 0
...
review           = 0
run              = all
runspec          = /home/clive/workspace/luxu/spec-cpu2006_backup/bin/runspec --action=build --config=riscv2.cfg --size=test --tune=base mcf
safe_eval        = 1
