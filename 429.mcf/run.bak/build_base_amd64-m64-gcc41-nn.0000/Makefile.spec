...
commandexe       = mcf_base.amd64-m64-gcc41-nn
...
compwhite        = 
configdir        = config
configpath       = /home/tiger/workspace/spec/spec-cpu2006_backup/config/riscv.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log              = CPU2006
log_line_width   = 0
logname          = /home/tiger/workspace/spec/spec-cpu2006_backup/result/CPU2006.033.log
lognum           = 033
mach             = default
mail_reports     = all
mailcompress     = 0
...
output_root      = 
outputdir        = output
path             = /home/tiger/workspace/spec/spec-cpu2006_backup/benchspec/CPU2006/429.mcf
plain_train      = 1
prefix           = 
prepared_by      = 
rate             = 0
...
review           = 0
run              = all
runspec          = /home/tiger/workspace/spec/spec-cpu2006_backup/bin/runspec --config=riscv.cfg --action=build --tune=base mcf
safe_eval        = 1
