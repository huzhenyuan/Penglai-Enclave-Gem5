...
log              = CPU2006
log_line_width   = 0
logname          = /home/clive/workspace/luxu/spec-cpu2006_backup/result/CPU2006.034.log
lognum           = 034
mach             = default
mail_reports     = all
mailcompress     = 0
...
review           = 0
run              = all
runspec          = /home/clive/workspace/luxu/spec-cpu2006_backup/bin/runspec --config=riscv.cfg --action=build --tune=base mcf
safe_eval        = 1
