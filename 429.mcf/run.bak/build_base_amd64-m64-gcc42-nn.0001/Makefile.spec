...
commandexe       = mcf_base.amd64-m64-gcc42-nn
...
compwhite        = 
configdir        = config
configpath       = /home/xywang/primer/tmp/spec-cpu2006_backup/config/default.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log              = CPU2006
log_line_width   = 0
logname          = /home/xywang/primer/tmp/spec-cpu2006_backup/result/CPU2006.023.log
lognum           = 023
mach             = default
mail_reports     = all
mailcompress     = 0
...
output_root      = 
outputdir        = output
path             = /home/xywang/primer/tmp/spec-cpu2006_backup/benchspec/CPU2006/429.mcf
plain_train      = 1
prefix           = 
prepared_by      = 
rate             = 0
...
review           = 0
run              = all
runspec          = /home/xywang/primer/tmp/spec-cpu2006_backup/bin/runspec -v 5 --action onlyrun 429.mcf
safe_eval        = 1
...
tester           = 
top              = /home/xywang/primer/tmp/spec-cpu2006_backup
tune             = base
uid              = 1000
unbuffer         = 1
update-flags     = 0
