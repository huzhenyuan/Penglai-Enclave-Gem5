...
commandexe       = zeusmp_base.amd64-m64-gcc42-nn
...
log              = CPU2006
log_line_width   = 0
logname          = /home/tiger/workspace/spec/spec-cpu2006_backup/result/CPU2006.045.log
lognum           = 045
mach             = default
mail_reports     = all
mailcompress     = 0
...
output_root      = 
outputdir        = output
path             = /home/tiger/workspace/spec/spec-cpu2006_backup/benchspec/CPU2006/434.zeusmp
plain_train      = 1
prefix           = 
prepared_by      = 
rate             = 0
...
review           = 0
run              = all
runspec          = /home/tiger/workspace/spec/spec-cpu2006_backup/bin/runspec --action=build --config=default.cfg --tune=base zeusmp
safe_eval        = 1
