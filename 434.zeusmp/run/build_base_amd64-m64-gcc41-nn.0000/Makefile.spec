...
log              = CPU2006
log_line_width   = 0
logname          = /home/clive/workspace/luxu/spec-cpu2006_backup/result/CPU2006.065.log
lognum           = 065
mach             = default
mail_reports     = all
mailcompress     = 0
...
output_root      = 
outputdir        = output
path             = /home/clive/workspace/luxu/spec-cpu2006_backup/benchspec/CPU2006/434.zeusmp
plain_train      = 1
prefix           = 
prepared_by      = 
rate             = 0
...
review           = 0
run              = all
runspec          = /home/clive/workspace/luxu/spec-cpu2006_backup/bin/runspec --action=build --config=riscv.cfg --tune=base zeusmp
safe_eval        = 1
